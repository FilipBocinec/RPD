...
RcppExport SEXP _RPD_RPD_outl_C(SEXP xSEXP, SEXP XSEXP, SEXP betaSEXP, SEXP quantSEXP, SEXP nSEXP, SEXP dSEXP, SEXP mSEXP, SEXP ndirSEXP, SEXP ndir2SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(RPD_outl_C(x, X, beta, quant, n, d, m, ndir, ndir2));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_RPD_RPD_outl_C", (DL_FUNC) &_RPD_RPD_outl_C, 9},
    {NULL, NULL, 0}
};
